...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 table-responsive">
                    <table>
                      ...
                      <br>
                      	<button class="btn btn-success btn-round btn-xs botones"  id="btn_todo">TODO</button>
                      <br>
                  </div>
 ...
 <div id="detalle_todo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-header">
                ...
                <div class="modal-body">
                  ...
                  <div class="panel panel-warning">
                      ...
                      <div class="panel-heading"><b id="texto" class="text-warning">DETALLE DE TODO</b></div>
                      

                      <div class="panel-body">
                          <div class="col-md-12">
                            <div id="grafico_todo"></div>
                          </div>
...
$("#generar").on("click",function(){
  ...
  function tabla(data,nombres,opciones,activos){
        ...
        $("#data").html("<hr><br><button id='csv' class='btn btn-success pull-left'><i class='fa fa-file-excel-o btn-xs'></i> CSV</button>"+tabla);
    ...
    $("#tabla_detalle_dia").tableHeadFixer({"left" : 1}); 
        ...
        var tabla ='<table class="table table-bordered" style="display:none;" id="tabla_csv"><thead>'
                        +'<tr>'
                          +'<td align="center">Nombre</td>'
                          +'<td align="center">Fecha</td>'
                          +'<td align="center" class="pasos">Pasos</td>'
                          +'<td align="center" class="calorias">Calorias</td>'
                          +'<td align="center" class="ritmo_cardiaco">Ritmo Cardiaco</td>'
                          +'<td align="center" class="minutos">Minutos</td>'
                        +'</tr></thead><tbody>';
        ...
        $.each(nombres, function (i, nombre) {
        	...
        	$.each(data["info"+nombre.replace(" ","")], function(x, datos){
	        	 ...
	        	 tabla +="<tr>" 
	        	 			...
	        	 			+"<td class='pasos'>"+datos.pasos+"</td>"
	        	 			+"<td class='calorias'>"+datos.calorias+"</td>"
	        	 			+"<td class='ritmo_cardiaco'>"+datos.ritmo_cardiaco+"</td>"
	        	 			+"<td class='minutos'>"+datos.minutos+"</td>"
	        	 		+"</tr>"
	       	});
                          ...
                          if(dias == datos.dias){
                            $("#"+dias+nombre_id).append('<small class="badge badge-info"><i class="fa fa-calendar"></i> '+datos.creacion+'</small><br><span class="pull-right calorias">'
                                                                    ...
                                                                    +'<span class="pull-right">'
                                                                      +'<small>Tiempo</small> '
                                                                      +'<small><strong>'+datos.minutos+'</strong></small>' //'+arr[i]["sum_minutos"+dias+nombre_id]+'
                                                                    +'</span><br>'
...
var titulo = tipo;
  ...
  if(tipo == "cardiaco" || tipo == "calorias" || tipo == "pasos" || tipo == "minutos" || tipo == "hvr"){
  ...
  if(tipo == "cardiaco" || tipo == "calorias" || tipo == "pasos" || tipo == "minutos"){
    
    var arreglo_calorias = [];
    var arreglo_pasos = [];
      ...
      $.each(nombres, function(i, nombre){
        ...
        var todo = new Array();
          ...
          $.each(data["info"+nombre.replace(" ","")], function(x, datos){
               ...
               calorias[x] = new Array(cambiar,parseInt(datos.calorias));
               pasos[x] = new Array(cambiar,parseInt(datos.pasos));
               minutos[x] = new Array(cambiar,parseFloat(datos.minutos));
               todo[x] = new Array(cambiar,parseInt(datos.ritmo_cardiaco),parseInt(datos.calorias),parseInt(datos.pasos),parseFloat(datos.minutos));
           });

          obj[nombre.replace(" ","")+"_cardiaco"] = cardiaco;
          obj1[nombre.replace(" ","")+"_calorias"] = calorias;
          obj2[nombre.replace(" ","")+"_pasos"] = pasos;
          obj3[nombre.replace(" ","")+"_minutos"] = minutos;
          obj4[nombre.replace(" ","")+"_todo"] = todo;
          arreglo_ritmo_cardiaco.push(obj);
          arreglo_calorias.push(obj1);
          arreglo_pasos.push(obj2);
          arreglo_minutos.push(obj3);

          arreglo_todo.push(obj4);

      });

      grafico_todo(nombres,arreglo_todo);
    ...
    switch(tipo){
      ...
      case "cardiaco":
          $.each(nombres, function(i, nombre){
            ...
            chart.addSeries({                        
                name: nombre,
                data: arreglo_ritmo_cardiaco[i][nombre.replace(" ","")+"_"+tipo+""],
      ...
      case "calorias":
          $.each(nombres, function(i, nombre){
            ...
            chart.addSeries({                        
                name: nombre,
                data: arreglo_calorias[i][nombre.replace(" ","")+"_"+tipo+""],
                //pointStart: arreglo_ritmo_cardiaco[i][nombre.replace(" ","")+"_creacion"]
            }, false);
            chart.redraw();
      ...
      case "pasos":
          $.each(nombres, function(i, nombre){
            ...
            chart.addSeries({                        
                name: nombre,
                data: arreglo_pasos[i][nombre.replace(" ","")+"_"+tipo+""],
                //pointStart: arreglo_ritmo_cardiaco[i][nombre.replace(" ","")+"_creacion"]
            }, false);
            chart.redraw();
      ...
      case "minutos":
          $.each(nombres, function(i, nombre){
            ...
            chart.addSeries({                        
                name: nombre,
                data: arreglo_minutos[i][nombre.replace(" ","")+"_"+tipo+""],
                //pointStart: arreglo_ritmo_cardiaco[i][nombre.replace(" ","")+"_creacion"]
            }, false);
            chart.redraw();
 ...
 function grafico_todo(nombres,todo){

    var chart = Highcharts.chart('grafico_todo', {
        chart: {
            type: 'column'
        },
        title: {
    ...
    $.each(nombres, function(i, nombre){
      ...
      chart.addSeries({                        
          name: nombre,
          data: todo[i][nombre.replace(" ","")+"_todo"],
          //pointStart: arreglo_ritmo_cardiaco[i][nombre.replace(" ","")+"_creacion"]
      }, false);
      chart.redraw();
