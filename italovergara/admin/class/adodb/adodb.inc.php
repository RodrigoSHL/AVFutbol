...
*/
	...
	*/
	...
	function &_Execute($sql,$inputarr=false)
	{
		...
		*************************/
		...
		if ($this->queryID === true) { // return simplified recordset for inserts/updates/deletes with lower overhead
   ...
   /**
	...
	var $blobSize = 100; 	/// any varchar/char field this size or greater is treated as a blob
							/// in other words, we use a text Departamento for editing.
